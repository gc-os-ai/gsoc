# GC.OS Project Ideas List

This repository collects links to mentorships projects under the GC.OS umbrella for 2026, for:

* [European Summer of Code](https://github.com/european-summer-of-code/esoc2026/)
* [Google Summer of Code](https://summerofcode.withgoogle.com/)
* project specific mentorship programmes
...
* [`pgmpy` project ideas 2026] (https://github.com/pgmpy/pgmpy/wiki/GSoC-2026)
...
* [`pgmpy` contributor guide](https://github.com/pgmpy/pgmpy/blob/dev/Contributing.md)
